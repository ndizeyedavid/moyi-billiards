...
export default function Hero({
  badge = "Moyi Billiards",
  title1 = "Supercharged",
  title2 = "Billiard Tables",
}: {
  badge?: string;
  title1?: string;
  title2?: string;
    ...
    <div className="bg-background relative flex min-h-screen w-full items-center justify-center overflow-hidden dark:bg-black">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <ElegantShape
          ...
          className="top-[15%] left-[-10%] md:top-[20%] md:left-[2%]"
        />
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          >
            <h1 className="mx-4 mb-6 text-4xl font-bold tracking-tight sm:text-6xl md:mb-8 md:text-8xl">
              <span
                style={{
                  background: "linear-gradient(to right, #f83a3a, #7000ff)",
          ...
          >
            <p className="text-muted-foreground mx-auto mb-10 max-w-xl px-4 text-base leading-relaxed sm:text-lg md:text-xl">
              We offer top notch billard tables and accessories that are
              reliable and affordable to supercharge your fun
            </p>
          </motion.div>
